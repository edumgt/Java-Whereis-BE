...
<body>
	<header id="header" class="fixed-top header-inner-pages">
								...
								<div>
									<div class="portfolio-info">
										...
										<form id="form-join" action="">
											...
											<button type="button" class="btn btn-secondary" id="find-pwd-btn">비밀번호
												찾기</button>
										</form>
									</div>
								</div>
		...
		<script>
		document.querySelector("#find-pwd-btn").addEventListener("click", function findId(){
				if (!document.querySelector("#userId").value) {
					  ...
					  return;
						...
						.catch(error => {alert("매칭된 아이디와 이메일이 없습니다.")})
					}
			});
		</script>
		<!-- End Breadcrumbs -->
