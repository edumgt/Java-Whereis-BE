package com.ssafy.live.news.controller;
...
import com.ssafy.live.news.dto.RealEstateNews;
...
public class NewsController {
	...
	@GetMapping("/news/all")
	public ResponseEntity<?> getNewsList() throws IOException {
		...
		for (Element e : newsTable.select("dt")) {
			...
			title = e.text();
			if (!photo.isEmpty() && !title.isEmpty()) {
